...
proto.data.RecordLog.toObject = function(includeInstance, msg) {
  var f, obj = {
    loguuid: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
/**
 * optional string logUuid = 1;
 * @return {string}
 */
proto.data.RecordLog.prototype.getLoguuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.data.RecordLog.prototype.setLoguuid = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
